...
//--------------------------------------------------------------------------------
void CWallmarksEngine::RecurseTri(u32 t, fmat4x4& mView, CWallmarksEngine::static_wallmark& W)
{
	...
	// Some vars
	u32* v_ids = T->verts;
	fvec3* v_data = sml_collector.getV();
	sml_poly_src.clear();
...
void CWallmarksEngine::BuildMatrix(fmat4x4& mView, float invsz, const fvec3& from)
{
	// build projection
	fmat4x4 mScale;
	fvec3 at, up, right, y;
...
void CWallmarksEngine::AddWallmark_internal(CDB::TRI* pTri, const fvec3* pVerts, const fvec3& contact_point, ref_shader hShader, float sz)
{
...
void CWallmarksEngine::AddStaticWallmark(CDB::TRI* pTri, const fvec3* pVerts, const fvec3& contact_point, ref_shader hShader, float sz)
{
...
void CWallmarksEngine::AddSkeletonWallmark(const fmat4x4* xf, CKinematics* obj, ref_shader& sh, const fvec3& start, const fvec3& dir, float size)
{
...
void CWallmarksEngine::Render()
{
	...
	Engine.Statistic->RenderDUMP_WMD_Count = 0;
	Engine.Statistic->RenderDUMP_WMT_Count = 0;

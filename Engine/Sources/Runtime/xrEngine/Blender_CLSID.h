...
#define B_STATIC_MESH MK_CLSID('L', 'M', ' ', ' ', ' ', ' ', ' ', ' ')
#define B_STATIC_MESH_TRANSLUENT MK_CLSID('L', 'M', '_', 'A', 'R', 'E', 'F', ' ')
#define B_VERT MK_CLSID('V', ' ', ' ', ' ', ' ', ' ', ' ', ' ')
#define B_VERT_AREF MK_CLSID('V', '_', 'A', 'R', 'E', 'F', ' ', ' ')
#define B_TERRAIN_LIGHTMAPPED MK_CLSID('L', 'm', 'B', 'm', 'm', 'D', ' ', ' ')
#define B_LaEmB MK_CLSID('L', 'a', 'E', 'm', 'B', ' ', ' ', ' ')
#define B_LmEbB MK_CLSID('L', 'm', 'E', 'b', 'B', ' ', ' ', ' ')
#define B_B MK_CLSID('B', 'm', 'm', 'D', ' ', ' ', ' ', ' ')
#define B_TERRAIN MK_CLSID('B', 'm', 'm', 'D', 'o', 'l', 'd', ' ')
...
#define B_DETAIL_OBJECT MK_CLSID('D', '_', 'S', 'T', 'I', 'L', 'L', ' ')
#define B_MULTIPLE_USAGE MK_CLSID('D', '_', 'T', 'R', 'E', 'E', ' ', ' ')

#define B_SKINNED_MESH MK_CLSID('M', 'O', 'D', 'E', 'L', ' ', ' ', ' ')

...
TEMPLATE_SPECIALIZATION
IC void CPlanner::add_condition(typename inherited_planner::_world_operator* action, _condition_type condition_id, _value_type condition_value)
{
	inherited_planner::add_condition(action, condition_id, condition_value);
}

TEMPLATE_SPECIALIZATION
IC void CPlanner::add_effect(typename inherited_planner::_world_operator* action, _condition_type condition_id, _value_type condition_value)
{

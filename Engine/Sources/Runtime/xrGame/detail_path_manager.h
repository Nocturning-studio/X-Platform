...
class CDetailPathManager
{
  ...
  public:
	typedef associative_vector<u32, STravelParams> VELOCITIES;
  ...
  private:
	...
	fvec3 m_start_direction;
	fvec3 m_dest_position;
	fvec3 m_corrected_dest_position;
	fvec3 m_dest_direction;
  ...
  private:
	...
	IC void adjust_point(const fvec2& source, float yaw, float magnitude, fvec2& dest) const;
  ...
  public:
	...
	IC bool completed(const fvec3& position, bool bRealCompleted = true) const;
	bool valid(const fvec3& position) const;
  ...
  public:
	...
	IC const fvec3& start_position() const;
	IC const fvec3& start_direction() const;
	IC const fvec3& dest_position() const;
	IC const fvec3& dest_direction() const;
	...
	IC void set_start_position(const fvec3& start_position);
	IC void set_start_direction(const fvec3& start_direction);
	IC void set_dest_position(const fvec3& dest_position);
	IC void set_dest_direction(const fvec3& dest_direction);
  ...
  public:
	...
	u32 location_on_path(const CGameObject* object, float distance, fvec3& result) const;
};

...
IC CScriptSoundAction::CScriptSoundAction(LPCSTR caSoundToPlay, LPCSTR caBoneName, const fvec3& tPositionOffset,
										  const fvec3& tAngleOffset, bool bLooped, ESoundTypes sound_type)
{
	m_bLooped = bLooped;
	SetBone(caBoneName);
...
IC CScriptSoundAction::CScriptSoundAction(LPCSTR caSoundToPlay, const fvec3& tPosition, const fvec3& tAngleOffset,
...
IC CScriptSoundAction::CScriptSoundAction(CScriptSound& sound, LPCSTR caBoneName, const fvec3& tPositionOffset,
										  const fvec3& tAngleOffset, bool bLooped, ESoundTypes sound_type)
{
	m_bLooped = bLooped;
	SetBone(caBoneName);
...
IC CScriptSoundAction::CScriptSoundAction(CScriptSound& sound, const fvec3& tPosition, const fvec3& tAngleOffset,
										  bool bLooped, ESoundTypes sound_type)
{
	m_bLooped = bLooped;
	SetSound(sound);
...
IC void CScriptSoundAction::SetPosition(const fvec3& tPosition)
{
...
IC void CScriptSoundAction::SetAngles(const fvec3& tAngles)
{

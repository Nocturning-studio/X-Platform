...
inline OutputClass horrible_cast(const InputClass input)
{
	...
	typedef int ERROR_CantUseHorrible_cast[sizeof(InputClass) == sizeof(u) && sizeof(InputClass) == sizeof(OutputClass)
											   ? 1
											   : -1];
	u.in = input;
	return u.out;
...
class FastDelegate4
{
  ...
  public:
	...
	FastDelegate4(const Y* pthis,
				  DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const)
	{
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
	}
	template <class X, class Y>
...
class FastDelegate5
{
  ...
  public:
	...
	// Binding to non-const member functions
	template <class X, class Y>
	FastDelegate5(Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
																			 Param5 p5))
	{
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
	}
	...
	// Binding to const member functions.
	template <class X, class Y>
	FastDelegate5(const Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
																				   Param4 p4, Param5 p5) const)
	{
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
	}
	template <class X, class Y>
	inline void bind(const Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
																					  Param4 p4, Param5 p5) const)
	{
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
	}
...
class FastDelegate6
{
  ...
  public:
	...
	// Binding to non-const member functions
	template <class X, class Y>
	FastDelegate6(Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
																			 Param5 p5, Param6 p6))
	{
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
	}
...
class FastDelegate7
{
  ...
  public:
	...
	// Binding to non-const member functions
	template <class X, class Y>
	FastDelegate7(Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
																			 Param5 p5, Param6 p6, Param7 p7))
	{
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
	}
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	FastDelegate7(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6,
													 Param7 p7))
	{
		bind(function_to_bind);
	}
...
// N=8
template <class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7,
		  class Param8, class RetType = detail::DefaultVoid>
class FastDelegate8
{
  private:
	typedef typename detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  ...
  public:
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	FastDelegate8(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6,
													 Param7 p7, Param8 p8))
	{
		bind(function_to_bind);
	}
  ...
  private: // Invoker for static functions
	RetType InvokeStaticFunction(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7,
								 Param8 p8) const
	{
	...
	: public FastDelegate0<R>
{
  public:
	...
	template <class X, class Y>
	FastDelegate(Y* pthis, R (xr_stdcall X::*function_to_bind)()) : BaseType(pthis, function_to_bind)
	{
	}

	template <class X, class Y>
	FastDelegate(const Y* pthis, R (xr_stdcall X::*function_to_bind)() const) : BaseType(pthis, function_to_bind)
	{
	}
	...
	: public FastDelegate1<Param1, R>
{
  public:
	...
	template <class X, class Y>
	FastDelegate(Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1)) : BaseType(pthis, function_to_bind)
	{
	}

	template <class X, class Y>
	FastDelegate(const Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1) const)
	...
	: public FastDelegate2<Param1, Param2, R>
{
  public:
	...
	template <class X, class Y>
	FastDelegate(Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2))
		: BaseType(pthis, function_to_bind)
	{
	}

	template <class X, class Y>
	FastDelegate(const Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2) const)
		: BaseType(pthis, function_to_bind)
	{
	}

	FastDelegate(R (*function_to_bind)(Param1 p1, Param2 p2)) : BaseType(function_to_bind)
	{
	}
	void operator=(const BaseType& x)
	{
	...
	: public FastDelegate3<Param1, Param2, Param3, R>
{
  public:
	...
	template <class X, class Y>
	FastDelegate(Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3))
		: BaseType(pthis, function_to_bind)
	{
	}

	template <class X, class Y>
	FastDelegate(const Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3) const)
		: BaseType(pthis, function_to_bind)
	{
	}

	FastDelegate(R (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3)) : BaseType(function_to_bind)
	{
	}
	void operator=(const BaseType& x)
	{
	...
	: public FastDelegate4<Param1, Param2, Param3, Param4, R>
{
  public:
	...
	template <class X, class Y>
	FastDelegate(Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4))
		: BaseType(pthis, function_to_bind)
	{
	}

	template <class X, class Y>
	FastDelegate(const Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const)
		: BaseType(pthis, function_to_bind)
	{
	}

	FastDelegate(R (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) : BaseType(function_to_bind)
	{
	}
	void operator=(const BaseType& x)
	{
	...
	: public FastDelegate5<Param1, Param2, Param3, Param4, Param5, R>
{
  public:
	...
	template <class X, class Y>
	FastDelegate(Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5))
		: BaseType(pthis, function_to_bind)
	{
	}
	...
	: public FastDelegate6<Param1, Param2, Param3, Param4, Param5, Param6, R>
{
  public:
	...
	template <class X, class Y>
	FastDelegate(const Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
																	 Param5 p5, Param6 p6) const)
		: BaseType(pthis, function_to_bind)
	{
	}
...
template <class X, class Y, class Param1, class Param2, class RetType>
FastDelegate2<Param1, Param2, FASTDLGT_RETTYPE> MakeDelegate(Y* x,
															 RetType (xr_stdcall X::*func)(Param1 p1, Param2 p2) const)
{
	return FastDelegate2<Param1, Param2, FASTDLGT_RETTYPE>(x, func);
}
...
FastDelegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE> MakeDelegate(Y* x,
																	 RetType (xr_stdcall X::*func)(Param1 p1, Param2 p2,
																								   Param3 p3))
{

...
#include "xrGame/stalker_decision_space.h"
...
#include "xrGame/danger_cover_location.h"
...
#include "xrGame/BoneProtections.h"
#include "xrGame/RadioactiveZone.h"
#include "xrGame/restricted_object.h"
#include "xrGame/ai_object_location.h"
#include "xrGame/missile.h"
#include "xrGame/phworld.h"
#include "xrGame/stalker_animation_names.h"
...
void CAI_Stalker::g_fireParams(const CHudItem* pHudItem, fvec3& P, fvec3& D)
{
...
void CAI_Stalker::Hit(SHit* pHDS)
{
	...
	if(suppression_duration > 3000)
		suppression_duration = 3000;
...
void CAI_Stalker::HitSignal(float amount, fvec3& vLocalDir, CObject* who, s16 element)
{
	if(getDestroy())
		return;
...
void CAI_Stalker::can_kill_entity(const fvec3& position, const fvec3& direction, float distance,
...
void CAI_Stalker::can_kill_entity_from(const fvec3& position, fvec3 direction, float distance)
{
	m_pick_distance = 0.f;
	rq_storage.r_clear();
...
void CAI_Stalker::throw_target(const fvec3& position)
{

...
struct event_comparer_t
{
	shared_str name;
	s16 event;

	event_comparer_t(shared_str n, s16 e) : name(n), event(e)
	{
	}
...
void CUIDialogWndEx::AddCallback(LPCSTR control_id, s16 event, const luabind::functor<void>& functor,

...
struct CDataStorageDoubleLinkedList
{
	...
	class CDataStorage
		: public CDataStorageSingleLinkedList<sorted>::template CDataStorage<_data_storage,
																			 DoubleLinkedList<_vertex>::_vertex>
	{
	  public:
		typedef typename CDataStorageSingleLinkedList<sorted>::template CDataStorage<_data_storage,
																					 DoubleLinkedList<_vertex>::_vertex>
			inherited;

...
struct comparer
{
	...
	IC bool operator()(LPCSTR _1, LPCSTR _2) const
	{
		return (P<int>()(xr_strcmp(_1, _2), 0));
	}
	IC bool operator()(LPSTR _1, LPSTR _2) const
	{
		return (P<int>()(xr_strcmp(_1, _2), 0));
	}
	IC bool operator()(LPCSTR _1, LPSTR _2) const
	{
		return (P<int>()(xr_strcmp(_1, _2), 0));
	}
	IC bool operator()(LPSTR _1, LPCSTR _2) const
	{
		return (P<int>()(xr_strcmp(_1, _2), 0));
	}
};

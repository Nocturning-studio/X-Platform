...
struct CDataStorageBucketList
{
	...
	class CDataStorage
		: public CDataStorageDoubleLinkedList<false>::template CDataStorage<_data_storage, BucketList<_vertex>::_vertex>
	{
	  public:
		typedef typename CDataStorageDoubleLinkedList<false>::template CDataStorage<_data_storage,

...
class CGameSpy_Browser
{
  ...
  private:
	...
	GAMESPY_FN_VAR_DECL(SBError, ServerBrowserAuxUpdateServer,
						(void* sb, void* server, SBBool async, SBBool fullUpdate));
	GAMESPY_FN_VAR_DECL(SBError, ServerBrowserAuxUpdateIP,
						(void* sb, const char* ip, unsigned short port, SBBool viaMaster, SBBool async,
						 SBBool fullUpdate));

	GAMESPY_FN_VAR_DECL(const char*, SBServerGetPlayerStringValue,
	...
	GAMESPY_FN_VAR_DECL(double, SBServerGetPlayerFloatValue,
						(void* server, int playernum, const char* key, double fdefault));

	GAMESPY_FN_VAR_DECL(const char*, SBServerGetTeamStringValue,
	...
	GAMESPY_FN_VAR_DECL(double, SBServerGetTeamFloatValue,

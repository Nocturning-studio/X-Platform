...
vec_t vec_c(float _x, float _y, float _z)
{
	vec_t v;
	v.x = _x;
	v.y = _y;
						...
						float _range)
{
	...
	if (CPU::ID.hasFeature(CpuFeature::Sse))
	{
		if (_o & O_ONLYFIRST)
		{
			if (_o & O_ONLYNEAREST)
			{
				CWalkerQRay<true, true, true> W(this, _mask_and, _start, _dir, _range);
				W.walk(m_root, m_center, m_bounds);
			}
			else
			{
				CWalkerQRay<true, true, false> W(this, _mask_and, _start, _dir, _range);
				W.walk(m_root, m_center, m_bounds);
			}
		}
		else
		{
			if (_o & O_ONLYNEAREST)
			{
				CWalkerQRay<true, false, true> W(this, _mask_and, _start, _dir, _range);
				W.walk(m_root, m_center, m_bounds);
			}
			else
			{
				CWalkerQRay<true, false, false> W(this, _mask_and, _start, _dir, _range);
				W.walk(m_root, m_center, m_bounds);
			}
		}
	}
	else
	{
		if (_o & O_ONLYFIRST)
		{
			if (_o & O_ONLYNEAREST)
			{
				CWalkerQRay<false, true, true> W(this, _mask_and, _start, _dir, _range);
				W.walk(m_root, m_center, m_bounds);
			}
			else
			{
				CWalkerQRay<false, true, false> W(this, _mask_and, _start, _dir, _range);
				W.walk(m_root, m_center, m_bounds);
			}
		}
		else
		{
			if (_o & O_ONLYNEAREST)
			{
				CWalkerQRay<false, false, true> W(this, _mask_and, _start, _dir, _range);
				W.walk(m_root, m_center, m_bounds);
			}
			else
			{
				CWalkerQRay<false, false, false> W(this, _mask_and, _start, _dir, _range);
				W.walk(m_root, m_center, m_bounds);
			}
		}
	}

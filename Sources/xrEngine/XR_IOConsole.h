...
class ENGINE_API CConsole : public pureRender, public pureFrame
{
  ...
  protected:
	...
	ref_shader m_hShader_back;
	ref_geom m_hGeom_con;
  ...
  public:
	...
	fvec3 GetFVector(LPCSTR cmd) const;
	fvec3* GetFVectorPtr(LPCSTR cmd) const;
  ...
  protected:
	...
	void DrawRect(FVF::TL*& TL_pv, Frect const& r, u32 color);

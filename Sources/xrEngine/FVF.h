...
struct L
{
	...
	IC void set(const fvec3& _p, u32 C)
	{
		p.set(_p);
		color = C;
	}
...
struct V
{
	...
	IC void set(const fvec3& _p, float u, float v)
	{
		p.set(_p);
		t.set(u, v);
	}
...
struct LIT
{
	...
	IC void set(const fvec3& _p, u32 C, float u, float v)
	{
		p.set(_p);
		color = C;
		t.set(u, v);
...
struct TL0uv
{
	...
	IC void transform(const fvec3& v, const fmat4x4& matSet)
	{
...
struct TL
{
	...
	IC void set(float x, float y, u32 c, fvec2& t)
	{
...
struct TL2uv
{
	...
	IC void set(float x, float y, u32 c, fvec2& t0, fvec2& t1)
	{
		set(x, y, .0001f, .9999f, c, t0.x, t0.y, t1.x, t1.y);
	};
	IC void set(float x, float y, float z, float w, u32 c, fvec2& t0, fvec2& t1)
	{

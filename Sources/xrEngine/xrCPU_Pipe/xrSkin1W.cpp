...
void __stdcall xrSkin1W_x86(vertRender* D, vertBoned1W* S, u32 vCount, CBoneInstance* Bones)
{
	...
	for (; S != E;)
	{
		float4x4& M0 = Bones[S->matrix].mRenderTransform;
		...
		float4x4& M1 = Bones[S->matrix].mRenderTransform;
		...
		float4x4& M2 = Bones[S->matrix].mRenderTransform;
		...
		float4x4& M3 = Bones[S->matrix].mRenderTransform;
		...
		float4x4& M4 = Bones[S->matrix].mRenderTransform;
		...
		float4x4& M5 = Bones[S->matrix].mRenderTransform;
		...
		float4x4& M6 = Bones[S->matrix].mRenderTransform;
		...
		float4x4& M7 = Bones[S->matrix].mRenderTransform;
	...
	for (; S != E2;)
	{
		float4x4& M = Bones[S->matrix].mRenderTransform;

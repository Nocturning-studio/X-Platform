...
// Monsters
// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
IC CScriptMovementAction::CScriptMovementAction(MonsterSpace::EScriptMonsterMoveAction tAct, fvec3& tPosition,
...
IC void CScriptMovementAction::SetPosition(const fvec3& tPosition)
{

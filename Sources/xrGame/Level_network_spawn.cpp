...
void CLevel::g_cl_Spawn(LPCSTR name, u8 rp, u16 flags, float3 pos)
{
	// Create
...
CSE_Abstract* CLevel::spawn_item(LPCSTR section, const float3& position, u32 level_vertex_id, u16 parent_id,
								 bool return_item)
{

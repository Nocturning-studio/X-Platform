...
void CWeaponShotEffector::GetDeltaAngle(fvec3& delta_angle)
{
...
void CWeaponShotEffector::GetLastDelta(fvec3& delta_angle)
{
...
//-----------------------------------------------------------------------------
CCameraShotEffector::CCameraShotEffector(float max_angle, float relax_speed, float max_angle_horz,
										 float step_angle_horz, float angle_frac)

...
IC void CSoundMemoryManager::update_sound_threshold()
{
	...
	m_sound_threshold = std::max<float>(m_self_sound_factor * m_sound_threshold *
...
void CSoundMemoryManager::add(const CObject* object, int sound_type, const fvec3& position, float sound_power)
{

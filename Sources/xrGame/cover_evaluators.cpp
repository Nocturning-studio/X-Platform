...
void CCoverEvaluatorAngle::initialize(const float3& start_position, bool fake_call)
{
...
void CCoverEvaluatorAmbush::setup(const float3& my_position, const float3& enemy_position, float min_enemy_distance)
{
	inherited::setup();

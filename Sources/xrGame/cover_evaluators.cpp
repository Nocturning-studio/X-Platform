...
void CCoverEvaluatorAngle::initialize(const fvec3& start_position, bool fake_call)
{
...
void CCoverEvaluatorAmbush::setup(const fvec3& my_position, const fvec3& enemy_position, float min_enemy_distance)
{
	inherited::setup();

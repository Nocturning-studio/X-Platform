...
void CODEGeom::get_mass(dMass& m, const fvec3& ref_point, float density)
{
	get_mass(m);
...
void CODEGeom::get_mass(dMass& m, const fvec3& ref_point)
{
	get_mass(m);
	fvec3 l;
	l.sub(local_center(), ref_point);
...
void CODEGeom::add_self_mass(dMass& m, const fvec3& ref_point, float density)
{
	dMass self_mass;
...
void CODEGeom::add_self_mass(dMass& m, const fvec3& ref_point)
{
	dMass self_mass;
...
void CODEGeom::get_local_center_bt(fvec3& center)
{
	...
	center.set(*((const fvec3*)dGeomGetPosition(geom())));
}
void CODEGeom::get_local_form_bt(fmat4x4& form)
{
	PHDynamicData::DMXPStoFMX(dGeomGetRotation(geom()), dGeomGetPosition(geom()), form);
}
void CODEGeom::get_global_center_bt(fvec3& center)
{
	center.set(*((const fvec3*)dGeomGetPosition(m_geom_transform)));
	dVector3 add;
...
void CODEGeom::set_position(const fvec3& /*ref_point*/)
{
...
void CODEGeom::move_local_basis(const fmat4x4& inv_new_mul_old)
{
	fmat4x4 new_form;
...
void CODEGeom::build(const fvec3& ref_point)
{
	init();
...
void CBoxGeom::get_extensions_bt(const fvec3& axis, float center_prg, float& lo_ext, float& hi_ext)
{
...
void CBoxGeom::get_max_area_dir_bt(fvec3& dir)
{
...
const fvec3& CBoxGeom::local_center()
{
	return m_box.m_translate;
}

void CBoxGeom::get_local_form(fmat4x4& form)
{
	form._14 = 0;
	form._24 = 0;
	form._34 = 0;
...
void CBoxGeom::set_local_form(const fmat4x4& form)
{
...
void CBoxGeom::set_position(const fvec3& ref_point)
{
...
void CSphereGeom::get_extensions_bt(const fvec3& axis, float center_prg, float& lo_ext, float& hi_ext)
{
	VERIFY(m_geom_transform);
	const dReal* rot = NULL;
	const dReal* pos = NULL;
...
const fvec3& CSphereGeom::local_center()
{
	return m_sphere.P;
}

void CSphereGeom::get_local_form(fmat4x4& form)
{
	form.identity();
	form.c.set(m_sphere.P);
}
void CSphereGeom::set_local_form(const fmat4x4& form)
{
...
void CSphereGeom::set_position(const fvec3& ref_point)
{
...
void CCylinderGeom::get_extensions_bt(const fvec3& axis, float center_prg, float& lo_ext, float& hi_ext)
{
	VERIFY(m_geom_transform);
	const dReal* rot = NULL;
	const dReal* pos = NULL;
...
const fvec3& CCylinderGeom::local_center()
{
	return m_cylinder.m_center;
}

void CCylinderGeom::get_local_form(fmat4x4& form)
{
	form._14 = 0;
	form._24 = 0;
	form._34 = 0;
	...
	fvec3::generate_orthonormal_basis(form.j, form.k, form.i);
	form.c.set(m_cylinder.m_center);
}
void CCylinderGeom::set_local_form(const fmat4x4& form)
{
...
void CCylinderGeom::set_position(const fvec3& ref_point)
{

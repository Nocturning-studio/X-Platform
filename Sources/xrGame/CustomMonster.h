					   ...
					   public Feel::Touch
{
  ...
  public:
	...
	// utils
	void mk_orientation(fvec3& dir, fmat4x4& mR);
	void mk_rotation(fvec3& dir, SRotation& R);
  ...
  public:
	...
	virtual void SelectAnimation(const fvec3& _view, const fvec3& _move, float speed) = 0;
	...
	virtual bool bfExecMovement()
	{
		return (false);
	};

	IC bool angle_lerp_bounds(float& a, float b, float c, float d);
	IC void vfNormalizeSafe(fvec3& Vector);
  ...
  public:
	IC const bool& already_dead() const
	{
		return (m_already_dead);
	};

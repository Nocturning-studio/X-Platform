...
void CALifeMonsterPatrolPathManager::script_register(lua_State* L)
{
	module(L)[class_<CALifeMonsterPatrolPathManager>("CALifeMonsterPatrolPathManager")
				  ...
				  .def("route_type", (void(CALifeMonsterPatrolPathManager::*)(const EPatrolRouteType&))(
										 &CALifeMonsterPatrolPathManager::route_type))
				  .def("route_type", (const EPatrolRouteType& (CALifeMonsterPatrolPathManager::*)()
										  const)(&CALifeMonsterPatrolPathManager::route_type))
				  ...
				  .def("use_randomness", (void(CALifeMonsterPatrolPathManager::*)(const bool&))(
											 &CALifeMonsterPatrolPathManager::use_randomness))
				  .def("use_randomness", (bool(CALifeMonsterPatrolPathManager::*)()
											  const)(&CALifeMonsterPatrolPathManager::use_randomness))

...
float3 CPatrolPathParams__point(const CPatrolPathParams* self, u32 index)
{
	THROW(self);
...
void CPatrolPathParams::script_register(lua_State* L)
{
	module(L)[class_<CPatrolPathParams>("patrol")
				  .enum_("start")[value("start", int(PatrolPathManager::ePatrolStartTypeFirst)),
				  ...
				  .enum_("stop")[value("stop", int(PatrolPathManager::ePatrolRouteTypeStop)),
				  ...
				  .def(constructor<LPCSTR, const PatrolPathManager::EPatrolStartType,
								   const PatrolPathManager::EPatrolRouteType>())
				  .def(constructor<LPCSTR, const PatrolPathManager::EPatrolStartType,
								   const PatrolPathManager::EPatrolRouteType, bool>())
				  .def(constructor<LPCSTR, const PatrolPathManager::EPatrolStartType,
								   const PatrolPathManager::EPatrolRouteType, bool, u32>())
				  ...
				  .def("get_nearest", (u32(CPatrolPathParams::*)(const float3&) const)(&CPatrolPathParams::point))

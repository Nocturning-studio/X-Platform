...
void CScriptFlags::script_register(lua_State* L)
{
	module(L)[
		...
		class_<Flags16>("flags16")
			...
			.def("or", (Flags16 & (Flags16::*)(const Flags16::TYPE))(&Flags16::bit_or))
			.def("or", (Flags16 & (Flags16::*)(const Flags16&, const Flags16::TYPE))(&Flags16::bit_or))
			.def("and", (Flags16 & (Flags16::*)(const Flags16::TYPE))(&Flags16::bit_and))
			.def("and", (Flags16 & (Flags16::*)(const Flags16&, const Flags16::TYPE))(&Flags16::bit_and))
			.def("set", &set<Flags16>)
			.def("is", &is<Flags16>)
		...
		class_<Flags32>("flags32")
			...
			.def("or", (Flags32 & (Flags32::*)(const Flags32::TYPE))(&Flags32::bit_or))
			.def("or", (Flags32 & (Flags32::*)(const Flags32&, const Flags32::TYPE))(&Flags32::bit_or))
			.def("and", (Flags32 & (Flags32::*)(const Flags32::TYPE))(&Flags32::bit_and))
			.def("and", (Flags32 & (Flags32::*)(const Flags32&, const Flags32::TYPE))(&Flags32::bit_and))
			.def("set", &set<Flags32>)
			.def("is", &is<Flags32>)

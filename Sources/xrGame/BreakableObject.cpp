...
void CBreakableObject::Break()
{
	...
	m_break_time = Engine.TimeManager.GetGlobalTimeMs();
	SheduleRegister();
}
...
void CBreakableObject::ObjectContactCallback(bool& /**do_colide/**/, bool bo1, dContact& c, SGameMtl* /*material_1*/,
											 SGameMtl* /*material_2*/)
{
	...
	if (this_object->m_damage_threshold < c_damage && this_object->m_max_frame_damage < c_damage)
	{
		...
		this_object->m_contact_damage_dir.set(-c.geom.normal[0] * norm_sign, -c.geom.normal[1] * norm_sign,

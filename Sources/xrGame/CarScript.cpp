...
void CCar::script_register(lua_State* L)
{
	module(L)[class_<CCar, bases<CGameObject, CHolderCustom>>("CCar")
				  .enum_("wpn_action")[value("eWpnDesiredDir", int(CCarWeapon::eWpnDesiredDir)),
				  ...
				  //		.def("SetParam",		(void (CCar::*)(int,float2)) &CCar::SetParam)
				  .def("SetParam", (void(CCar::*)(int, float3)) & CCar::SetParam)

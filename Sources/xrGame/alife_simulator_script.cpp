...
CSE_Abstract* CALifeSimulator__spawn_item(CALifeSimulator* self, LPCSTR section, const fvec3& position,
...
CSE_Abstract* CALifeSimulator__spawn_item2(CALifeSimulator* self, LPCSTR section, const fvec3& position,
										   u32 level_vertex_id, GameGraph::_GRAPH_ID game_vertex_id,
...
CSE_Abstract* CALifeSimulator__spawn_ammo(CALifeSimulator* self, LPCSTR section, const fvec3& position,
										  u32 level_vertex_id, GameGraph::_GRAPH_ID game_vertex_id,
...
{
	module(
		L)[class_<CALifeSimulator>("alife_simulator")

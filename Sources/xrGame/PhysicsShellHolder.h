...
{
	typedef void CollisionHitCallbackFun(CGameObject* obj, float min_cs, float max_cs, float& cs, float& hl,
										 const ICollisionDamageInfo* di, SCollisionHitCallback* slf);
...

{
  ...
  public:
	...
	virtual void PHSetLinearVell(fvec3& velocity);

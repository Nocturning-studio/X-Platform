...
class CSightAction : public CControlAction
{
  ...
  protected:
	fvec3 m_holder_start_position;
	fvec3 m_object_start_position;
  ...
  public:
	...
	IC CSightAction(const ESightType& sight_type, const fvec3& vector3d, bool torso_look = false);
	IC CSightAction(const ESightType& sight_type, const fvec3* vector3d);
	...
	void initialize();
	void execute();
	IC void set_vector3d(const fvec3& position);

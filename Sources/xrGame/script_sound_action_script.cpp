...
void CScriptSoundAction::script_register(lua_State* L)
{
	module(L)[class_<CScriptSoundAction>("sound")
				  ...
				  .def(constructor<LPCSTR, LPCSTR, const float3&>())
				  .def(constructor<LPCSTR, LPCSTR, const float3&, const float3&>())
				  .def(constructor<LPCSTR, LPCSTR, const float3&, const float3&, bool>())
				  .def(constructor<LPCSTR, const float3&>())
				  .def(constructor<LPCSTR, const float3&, const float3&>())
				  .def(constructor<LPCSTR, const float3&, const float3&, bool>())
				  .def(constructor<CScriptSound&, LPCSTR, const float3&>())
				  .def(constructor<CScriptSound&, LPCSTR, const float3&, const float3&>())
				  .def(constructor<CScriptSound&, LPCSTR, const float3&, const float3&, bool>())
				  .def(constructor<CScriptSound&, const float3&>())
				  .def(constructor<CScriptSound&, const float3&, const float3&>())
				  .def(constructor<CScriptSound&, const float3&, const float3&, bool>())
				  // monster specific

...
void CPHJoint::CreateBall()
{
	...
	fvec3 pos;
	fmat4x4 first_matrix, second_matrix;
...
void CPHJoint::CalcAxis(int ax_num, fvec3& axis, float& lo, float& hi, const fmat4x4& first_matrix,
...
void CPHJoint::GetAxisDir(int num, fvec3& axis, eVs& vs)
{
	LimitAxisNum(num);
	vs = axes[num].vs;
...
void CPHJoint::GetAxisDirDynamic(int num, fvec3& axis)
{
	LimitAxisNum(num);
	dVector3 result;
	switch (eType)
...
void CPHJoint::GetAnchorDynamic(fvec3& anchor)
{

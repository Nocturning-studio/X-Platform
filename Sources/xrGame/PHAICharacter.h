...
class CPHAICharacter : public CPHSimpleCharacter
{
  ...
  public:
	...
	virtual bool TryPosition(float3 pos, bool exact_state);
	virtual void Jump(const float3& jump_velocity);
	...
	{
		return m_forced_physics_control;
	}

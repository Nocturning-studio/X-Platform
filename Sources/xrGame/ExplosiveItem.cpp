...
// void CExplosiveItem::Hit(float P, fvec3 &dir,	CObject* who, s16 element,
//						fvec3 position_in_object_space, float impulse,
...
{
	CParticlesPlayer::StartParticles(pSettings->r_string(*cNameSect(), "set_timer_particles"), fvec3().set(0, 1, 0),
									 ID());
}
...
void CExplosiveItem::ActivateExplosionBox(const fvec3& size, fvec3& in_out_pos)
{
	// PKinematics(Visual())->CalculateBones();
}
void CExplosiveItem::GetRayExplosionSourcePos(fvec3& pos)
{

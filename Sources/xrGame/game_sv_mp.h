...
class game_sv_mp : public game_sv_GameState
{
  ...
  protected:
	...
	virtual bool Player_RankUp_Allowed()
	{
		return m_bRankUp_Allowed;
	};
	virtual void Player_ExperienceFin(game_PlayerState* ps);
	virtual void Set_RankUp_Allowed(bool RUA)
	{
		m_bRankUp_Allowed = RUA;
	};
  ...
  public:
	...
	virtual u32 GetTeamCount()
	{
		return TeamList.size();
	};
	TeamStruct* GetTeamData(u32 Team);

	virtual u8 GetSpectatorModes()
	{
		return m_u8SpectatorModes;
	};

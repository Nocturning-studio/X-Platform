...
// void CBaseMonster::Hit(float P,fvec3 &dir,CObject*who,s16 element,fvec3 p_in_object_space,float impulse,
...
void CBaseMonster::PHHit(float P, fvec3& dir, CObject* who, s16 element, fvec3 p_in_object_space, float impulse,
...
CParticlesObject* CBaseMonster::PlayParticles(const shared_str& name, const fvec3& position, const fvec3& dir,
											  BOOL auto_remove, BOOL transformed)
{
	...
	matrix.identity();
	matrix.k.set(dir);
	fvec3::generate_orthonormal_basis_normalized(matrix.k, matrix.j, matrix.i);

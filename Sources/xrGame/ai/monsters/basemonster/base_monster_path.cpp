...
void CBaseMonster::LookPosition(float3 to_point, float angular_speed)
{
...
bool CBaseMonster::GetCorpseCover(float3& position, u32& vertex_id)
{
...
bool CBaseMonster::GetCoverFromEnemy(const float3& enemy_pos, float3& position, u32& vertex_id)
{
...
bool CBaseMonster::GetCoverFromPoint(const float3& pos, float3& position, u32& vertex_id, float min_dist,
...
bool CBaseMonster::GetCoverCloseToPoint(const float3& dest_pos, float min_dist, float max_dist, float deviation,
										float radius, float3& position, u32& vertex_id)
{

...
void CBaseMonster::LookPosition(fvec3 to_point, float angular_speed)
{
...
bool CBaseMonster::GetCorpseCover(fvec3& position, u32& vertex_id)
{
...
bool CBaseMonster::GetCoverFromEnemy(const fvec3& enemy_pos, fvec3& position, u32& vertex_id)
{
...
bool CBaseMonster::GetCoverFromPoint(const fvec3& pos, fvec3& position, u32& vertex_id, float min_dist,
...
bool CBaseMonster::GetCoverCloseToPoint(const fvec3& dest_pos, float min_dist, float max_dist, float deviation,
										float radius, fvec3& position, u32& vertex_id)
{

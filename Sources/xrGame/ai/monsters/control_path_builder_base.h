...
class CControlPathBuilderBase : public CControl_ComBase
{
  ...
  public:
	...
	IC void set_use_dest_orient(bool new_val)
	{
		m_use_dest_orient = new_val;
	}
	IC void disable_path()
	{
		m_enable = false;
	}
	IC void enable_path()
	...
	IC void extrapolate_path(bool val)
	{
		m_extrapolate = val;
	}
	...
	IC void set_velocity_mask(u32 mask)
	{
		m_velocity_mask = mask;
	}
	IC void set_desirable_mask(u32 mask)
	{

...
void CMonsterSoundMemory::HearSound(const CObject* who, int eType, const float3& Position, float power, TTime time)
{
	SoundElem s;
...
struct pred_remove_nonactual_sounds
{
	...
	pred_remove_nonactual_sounds(TTime time)
	{
		new_time = time;
	}

...
void CPHWorld::Create()
{
	...
	Engine.ThreadManager.LegacyFrameMT.Add(this, REG_PRIORITY_HIGH);
...
void CPHWorld::Step()
{
	...
	++m_steps_num;
	Engine.Statistic->ph_collision.Begin();
	...
	Engine.Statistic->ph_collision.End();
	...
	Engine.Statistic->ph_core.Begin();
#ifdef DEBUG
	dbg_bodies_num = 0;
	dbg_joints_num = 0;
	dbg_islands_num = 0;

...
class CMovementManager
{
  ...
  private:
	...
	bool m_enabled;
	fvec3 m_on_disable_object_position;
  ...
  public:
	...
	virtual void on_frame(CPHMovementControl* movement_control, fvec3& dest_position);
	...
	void update_path();
	virtual void move_along_path(CPHMovementControl* movement_control, fvec3& dest_position, float time_delta);

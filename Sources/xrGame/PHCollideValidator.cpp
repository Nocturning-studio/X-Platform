...
Flags<CLClassBits> CPHCollideValidator::ClassFlags = {CLClassBits(0)};
Flags<CLClassBits> CPHCollideValidator::ClassNCFlags = {CLClassBits(0)};
Flags<CLClassBits> CPHCollideValidator::NonTypeFlags = {CLClassBits(0)};

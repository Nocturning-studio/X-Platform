...
IC bool CGraphEngine::search(const _Graph& graph, const _index_type& start_node, const _index_type& dest_node,
...
IC bool CGraphEngine::search(const CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>& graph,
							 ...
							 xr_vector<_solver_edge_type>* node_path, const _Parameters& parameters)
{
	...
	typedef CPathManager<CSProblemSolver, CSolverAlgorithm::CDataStorage, _Parameters, _solver_dist_type,
						 _solver_index_type, GraphEngineSpace::_iteration_type>
		CSolverPathManager;

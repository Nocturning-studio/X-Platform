...
IC bool CDetailPathManager::completed(const fvec3& position, bool bRealCompleted) const
{
	return (m_path.empty() ||
...
IC void CDetailPathManager::set_start_position(const fvec3& start_position)
{
	m_start_position = start_position;
}

IC void CDetailPathManager::set_start_direction(const fvec3& start_direction)
{
...
IC void CDetailPathManager::set_dest_direction(const fvec3& dest_direction)
{
	m_actuality = m_actuality && m_dest_direction.similar(dest_direction);
	m_dest_direction = dest_direction;
}

IC const fvec3& CDetailPathManager::start_position() const
{
	return (m_start_position);
}

IC const fvec3& CDetailPathManager::start_direction() const
{
	return (m_start_direction);
}

IC const fvec3& CDetailPathManager::dest_position() const
{
	return (m_dest_position);
}

IC const fvec3& CDetailPathManager::dest_direction() const
{

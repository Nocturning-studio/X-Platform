										 ...
										 dReal* proj)
{
	...
	dReal t = (dDOT(ac, vc2) * dDOT41(vc1, vc2) - dDOT41(vc1, ac) * dDOT(vc2, vc2)) / factor;
										  ...
										  dReal* proj)
{
	...
	dReal t = (dDOT14(ac, vc2) * dDOT14(vc1, vc2) - dDOT(vc1, ac) * dDOT44(vc2, vc2)) / factor;
...
/*
inline dReal FragmentonBoxTest1(const dReal* Pt1,const dReal* Pt2,const dReal* BxP,const dReal* BxEx,const dReal*
R,dReal* norm){

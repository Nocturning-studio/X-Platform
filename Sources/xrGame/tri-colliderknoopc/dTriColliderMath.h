...
inline bool TriContainPoint(const dReal* v0, const dReal* v1, const dReal* v2, const dReal* triSideAx0,
							const dReal* triSideAx1, const dReal* triSideAx2, const dReal* triAx, const dReal* pos)
{
...
ICF void InitTriangle(CDB::TRI* XTri, Triangle& triangle, const fvec3* V_array)
{
...
ICF void CalculateTri(CDB::TRI* XTri, const float* pos, Triangle& triangle, const fvec3* V_array)
{

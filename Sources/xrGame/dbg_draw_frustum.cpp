...
#ifdef DEBUG
void MK_Frustum(CFrustum& F, float FOV, float _FAR, float A, float3& P, float3& D, float3& U)
{
	...
	float3 sPts[4]; // silhouette points (corners of window)
	float3 Offset, T;
	Offset.add(D, COP);

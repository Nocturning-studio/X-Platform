...
CUIPdaKillMessage::CUIPdaKillMessage()
{
	...
	m_victim_name.SetTextComplexMode(true);
	AttachChild(&m_killer_name);
	m_killer_name.SetTextComplexMode(true);
	AttachChild(&m_initiator);
	m_initiator.SetTextComplexMode(true);
	AttachChild(&m_ext_info);
	m_ext_info.SetTextComplexMode(true);
}
...
{
	m_victim_name.SetTextColor(color_set_alpha(m_victim_name.GetTextColor(), color_get_A(color)));
	m_killer_name.SetTextColor(color_set_alpha(m_killer_name.GetTextColor(), color_get_A(color)));

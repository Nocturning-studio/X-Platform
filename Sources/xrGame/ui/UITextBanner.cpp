...
void CUITextBanner::EffectFade()
{
	...
	{
		m_Cl = color_set_alpha(GetTextColor(), u8(iFloor(255.f * (fade.fTimePassed / fade.fPeriod))));
	}
	else
	{
		m_Cl = color_set_alpha(GetTextColor(), u8(iFloor(255.f * (1 - (fade.fTimePassed / fade.fPeriod)))));
	}
}
...
void CUITextBanner::EffectFlicker()
{
	...
	{
		m_Cl = color_set_alpha(GetTextColor(), 0);
	}
	else
	{
		m_Cl = color_set_alpha(GetTextColor(), 255);
	}
}

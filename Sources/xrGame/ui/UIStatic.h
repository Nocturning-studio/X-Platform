...
class CUIStatic : public CUIWindow, public CUISingleTextureOwner, public IUITextControl
{
  ...
  public:
	...
	{
		m_UIStaticItem.SetOriginalRectEx(r);
	}
	//
	...
	u32& GetColorRef()
	{
		return m_UIStaticItem.GetColorRef();
	}
	virtual void InitTexture(LPCSTR tex_name);
	virtual void InitTextureEx(LPCSTR tex_name, LPCSTR sh_name = "hud\\default");
	CUIStaticItem* GetStaticItem()
	{
		return &m_UIStaticItem;
	}
	...
	Fvector2 GetTextureOffeset() const
	{
	...
	void TextureAvailable(bool value)
	{
		m_bAvailableTexture = value;
	}
	bool TextureAvailable()
	{
		return m_bAvailableTexture;
	}

	// own
	virtual void SetHighlightColor(const u32 uColor)
	{
		m_HighlightColor = uColor;
	}
	...
	{
		SetTextColor(color_argb(a, r, g, b));
	}
	u32& GetTextColorRef();
	...
	{
		m_bEnableTextHighlighting = bHighlight;
	}
	...
	virtual void SetTextX(float text_x)
	{
		m_TextOffset.x = text_x;
	}
	virtual void SetTextY(float text_y)
	{
		m_TextOffset.y = text_y;
	}
	...
	{
		m_bStretchTexture = stretch_texture;
	}

...
template <typename T>
IC const CPatrolPath::CVertex* CPatrolPath::point(const float3& position, const T& evaluator) const
{
...
IC const CPatrolPath::CVertex* CPatrolPath::point(const float3& position) const
{

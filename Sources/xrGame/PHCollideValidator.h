...
class CPHCollideValidator
{
  ...
  public:
	...
	static IC bool DoCollide(const CPHObject& obj1, const CPHObject& obj2)
	{
		...
		case cbNCGroupObject:
			...
			break;
		case 0:
			return DoCollideNonMatched(obj1, obj2);
			break;
		default:
			NODEFAULT;
		}
  ...
  private:
	...
	static template_flags<CLClassBits> ClassFlags;
	static template_flags<CLClassBits> ClassNCFlags;
	static template_flags<CLClassBits> NonTypeFlags;
};

...
void actor_mp_state_holder::write(NET_Packet& packet)
{
	...
	if (check(physics_linear_velocity_x_flag))
		packet.w_float_q8(m_state.physics_linear_velocity.x, min_linear_velocity_component,
						  max_linear_velocity_component);
	if (check(physics_linear_velocity_y_flag))
		packet.w_float_q8(m_state.physics_linear_velocity.y, min_linear_velocity_component,
						  max_linear_velocity_component);
	if (check(physics_linear_velocity_z_flag))
		packet.w_float_q8(m_state.physics_linear_velocity.z, min_linear_velocity_component,
						  max_linear_velocity_component);
	...
	if (check(camera_yaw_flag))
		packet.w_float_q8(m_state.camera_yaw, 0.f, PI_MUL_2);
	if (check(camera_pitch_flag))
		packet.w_float_q8(m_state.camera_pitch, 0.f, PI_MUL_2);
	if (check(camera_roll_flag))
		packet.w_float_q8(m_state.camera_roll, 0.f, PI_MUL_2);
...
void actor_mp_state_holder::read(NET_Packet& packet)
{
	...
	if (check(physics_linear_velocity_x_flag))
		packet.r_float_q8(m_state.physics_linear_velocity.x, min_linear_velocity_component,
						  max_linear_velocity_component);
	if (check(physics_linear_velocity_y_flag))
		packet.r_float_q8(m_state.physics_linear_velocity.y, min_linear_velocity_component,
						  max_linear_velocity_component);
	if (check(physics_linear_velocity_z_flag))
		packet.r_float_q8(m_state.physics_linear_velocity.z, min_linear_velocity_component,
						  max_linear_velocity_component);
	if (check(physics_position_x_flag))
	...
	if (check(camera_yaw_flag))
		packet.r_float_q8(m_state.camera_yaw, 0.f, PI_MUL_2);
	if (check(camera_pitch_flag))
		packet.r_float_q8(m_state.camera_pitch, 0.f, PI_MUL_2);
	if (check(camera_roll_flag))
		packet.r_float_q8(m_state.camera_roll, 0.f, PI_MUL_2);

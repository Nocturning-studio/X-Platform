...
extern "C"
{
	...
	EXPORT_FN_DECL(void, qr2_register_key, (int keyid, const gsi_char* key));
	EXPORT_FN_DECL(void, qr2_think, (qr2_t qrec));
	EXPORT_FN_DECL(void, qr2_shutdown, (qr2_t qrec));
	EXPORT_FN_DECL(void, qr2_buffer_add, (qr2_buffer_t outbuf, const char* value));

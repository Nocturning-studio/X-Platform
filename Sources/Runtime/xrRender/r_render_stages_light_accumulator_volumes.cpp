...
void CRenderTarget::accum_spot_geom_create()
{
	...
	// vertices
	{
		...
		u32 vSize = 3 * 4;
		RenderBackend.CreateVertexBuffer(vCount * vSize, dwUsage, 0, D3DPOOL_DEFAULT, &g_accum_spot_vb, 0);
		BYTE* pData = 0;
	...
	// Indices
	{
		...
		BYTE* pData = 0;
		RenderBackend.CreateIndexBuffer(iCount * 2, dwUsage, D3DFMT_INDEX16, D3DPOOL_DEFAULT, &g_accum_spot_ib, 0);
...
void CRenderTarget::accum_point_geom_create()
{
	...
	// vertices
	{
		...
		u32 vSize = 3 * 4;
		RenderBackend.CreateVertexBuffer(vCount * vSize, dwUsage, 0, D3DPOOL_DEFAULT, &g_accum_point_vb, 0);
		BYTE* pData = 0;
	...
	// Indices
	{
		...
		BYTE* pData = 0;
		RenderBackend.CreateIndexBuffer(iCount * 2, dwUsage, D3DFMT_INDEX16, D3DPOOL_DEFAULT, &g_accum_point_ib, 0);
...
void CRenderTarget::accum_omnip_geom_create()
{
	...
	// vertices
	{
		...
		u32 vSize = 3 * 4;
		RenderBackend.CreateVertexBuffer(vCount * vSize, dwUsage, 0, D3DPOOL_DEFAULT, &g_accum_omnip_vb, 0);
		BYTE* pData = 0;
	...
	// Indices
	{
		...
		BYTE* pData = 0;
		RenderBackend.CreateIndexBuffer(iCount * 2, dwUsage, D3DFMT_INDEX16, D3DPOOL_DEFAULT, &g_accum_omnip_ib, 0);

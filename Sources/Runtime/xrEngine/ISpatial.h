...
class ENGINE_API ISpatial_DB
{
  ...
  private:
	IC u32 _octant(u32 x, u32 y, u32 z)
	{
		return z * 4 + y * 2 + x;
	}
	...
	void _insert(ISpatial_NODE* N, fvec3& n_center, float n_radius);
  ...
  public:
	...
	// query
	void q_ray(xr_vector<ISpatial*>& R, u32 _o, u32 _mask_and, const fvec3& _start, const fvec3& _dir,
			   float _range);
	void q_box(xr_vector<ISpatial*>& R, u32 _o, u32 _mask_or, const fvec3& _center, const fvec3& _size);
	void q_sphere(xr_vector<ISpatial*>& R, u32 _o, u32 _mask_or, const fvec3& _center, const float _radius);

...
//////////////////////////////////////////////////////////////////////
void CDemoRecord::update_whith_timescale(fvec3& v, const fvec3& v_delta)
{
...
void CDemoRecord::MakeLevelMapProcess()
{
	...
	case 2:
	{
		...
		sprintf_s(tmp, sizeof(tmp), "%s_[%3.3f, %3.3f]-[%3.3f, %3.3f]", *g_pGameLevel->name(), bb.min.x, bb.min.z,
				  bb.max.x, bb.max.z);
		Render->Screenshot(IRender_interface::ScreenshotMode::SM_FOR_LEVELMAP, tmp);
		psHUD_Flags.assign(s_hud_flag);
...
void CDemoRecord::MakeCubeMapFace(fvec3& D, fvec3& N)
{

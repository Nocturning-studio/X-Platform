...
struct clQueryCollision
{
	...
	IC void AddTri(const fmat4x4& m, const CDB::TRI* one, const fvec3* verts)
	{
		clQueryTri T;
	...
	IC void AddTri(const CDB::TRI* one, const fvec3* verts)
	{
		clQueryTri T;
	...
	IC void AddBox(const fmat4x4& M, const Fbox& B)
	{
		Fobb box;
		fvec3 c;
		B.getcenter(c);
...
class ENGINE_API ICollisionForm
{
  ...
  public:
	...
	// virtual void	_BoxQuery		( const Fbox& B, const fmat4x4& M, u32 flags)	= 0;
...
class ENGINE_API CCF_Skeleton : public ICollisionForm
{
  public:
	struct SElement
	{
	  ...
	  public:
		...
		void center(fvec3& center) const;
	};
  ...
  public:
	...
	bool _ElementCenter(u16 elem_id, fvec3& e_center);
...
class ENGINE_API CCF_EventBox : public ICollisionForm
{
  ...
  public:
	...
	virtual BOOL _RayQuery(const collide::ray_defs& Q, collide::rq_results& R);
	// virtual void	_BoxQuery		( const Fbox& B, const fmat4x4& M, u32 flags);

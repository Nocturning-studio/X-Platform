...
class ENGINE_API xrXRC
{
  ...
  public:
	...
	IC void ray_query(const CDB::MODEL* m_def, const fvec3& r_start, const fvec3& r_dir, float r_range = 10000.f)
	{
#ifdef DEBUG
	...
	IC void box_query(const CDB::MODEL* m_def, const fvec3& b_center, const fvec3& b_dim)
	{
#ifdef DEBUG

...
#define IMPLEMENT_IMPLICIT_NODE(baseclass, volume) \
  public:                                          \
	...
	{                                              \
		return (baseclass*)mData;                  \
	}                                              \
	inline_ const baseclass* GetNeg() const        \
	{                                              \
		return ((baseclass*)mData) + 1;            \
	}                                              \
	inline_ udword GetPrimitive() const            \
	{                                              \
		return udword(mData >> 1);                 \
	}                                              \
	/* Stats */                                    \
	inline_ size_t GetNodeSize() const             \
	{                                              \
		return SIZEOFOBJECT;                       \
	}                                              \
                                                   \
...
#define IMPLEMENT_NOLEAF_NODE(baseclass, volume) \
  public:                                        \
	...
	inline_ BOOL HasLeaf2() const                \
	{                                            \
		return (BOOL)(mData2 & 1);               \
	}                                            \
	/* Data access */                            \
	inline_ const baseclass* GetPos() const      \
	{                                            \
	...
	inline_ const baseclass* GetNeg() const      \
	{                                            \
		return (baseclass*)mData2;               \
	}                                            \
	inline_ udword GetPrimitive() const          \
	{                                            \
		return udword(mData >> 1);               \
	}                                            \
	inline_ udword GetPrimitive2() const         \
	{                                            \
		return udword(mData2 >> 1);              \
	}                                            \
	/* Stats */                                  \
	inline_ size_t GetNodeSize() const           \
	{                                            \

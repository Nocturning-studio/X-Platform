...
/* for encoding */
u8 p_len[64] = {0x03, 0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x06,
				0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07,
				0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07,
				0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08};

u8 p_code[64] = {0x00, 0x20, 0x30, 0x40, 0x50, 0x58, 0x60, 0x68, 0x70, 0x78, 0x80, 0x88, 0x90, 0x94, 0x98, 0x9C,
...
void Encode(void) /* compression */
{
	...
	for (i = s; i < r; i++)
		text_buf[i] = 0x20;
	for (length = 0; length < F && (c = fs._getb()) != EOF; length++)
		text_buf[r + length] = (unsigned char)c;
	textsize = length;
	for (i = 1; i <= F; i++)
		InsertNode(r - i);
	InsertNode(r);

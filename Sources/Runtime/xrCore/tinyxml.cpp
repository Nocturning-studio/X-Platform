...
#ifdef TIXML_USE_STL
TiXmlElement::TiXmlElement(const xr_string& _value) : TiXmlNode(TiXmlNode::ELEMENT)
{
	firstChild = lastChild = 0;
	value = _value;
}
...
TiXmlDeclaration::TiXmlDeclaration(const TiXmlDeclaration& copy) : TiXmlNode(TiXmlNode::DECLARATION)
{
	copy.CopyTo(this);
}

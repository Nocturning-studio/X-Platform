...
struct CCloner
{
	...
	{
		template <bool a>
		IC static void clone(const T& obj_1, T& obj_2)
		{
			obj_2 = obj_1;
		}

		template <>
		IC static void clone<true>(const T& obj_1, T& obj_2)
		{
	...
	IC static void clone(const std::pair<T1, T2>& obj_1, std::pair<T1, T2>& obj_2)
	{
	...
	IC static void clone(const svector<T, size>& obj_1, svector<T, size>& obj_2)
	{
	...
	template <typename T1, typename T2>
	IC static void clone(const xr_stack<T1, T2>& obj_1, xr_stack<T1, T2>& obj_2)
	{

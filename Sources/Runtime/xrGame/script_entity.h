...
class CScriptEntity
{
  public:
	struct CSavedSound
	{
		...
		IC CSavedSound(CScriptGameObject* lua_game_object, int sound_type, const fvec3& position, float sound_power)
  ...
  public:
	const fmat4x4 GetUpdatedMatrix(shared_str caBoneName, const fvec3& tPositionOffset, const fvec3& tAngleOffset);
	...
	virtual void sound_callback(const CObject* object, int sound_type, const fvec3& position, float sound_power);

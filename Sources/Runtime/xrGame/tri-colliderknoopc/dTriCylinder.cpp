...
int dcTriListCollider::dSortedTriCyl(const dReal* triSideAx0, const dReal* triSideAx1, const dReal* triAx,
									 ...
									 // const dReal* v1,
									 // const dReal* v2,
									 CDB::TRI* T, dReal dist, dxGeom* o1, dxGeom* o2, int flags, dContactGeom* contact,
									 int skip)
{
...
IC bool dcTriListCollider::cylinderCrossesLine(const dReal* p, const dReal* R, dReal hlz, const dReal* v0,
											   const dReal* v1, const dReal* l, dVector3 pos)
{

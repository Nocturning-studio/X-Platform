...
#include "xrGame/xrServer_Objects_ALife_Items.h"
...
#define UNHIGHTLIGHT_ITEM(x)                                                                                           \
	x->SetClrLightAnim(NULL, true, true, false, true);                                                                 \
...
class CUIBagWnd : public CUIStatic
{
  ...
  public:
	...
	void IgnoreRank(bool ignore)
	{
		m_bIgnoreRank = ignore;
	};

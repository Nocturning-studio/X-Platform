...
class CUICustomMap : public CUIStatic, public CUIWndCallback
{
  ...
  public:
	...
	{
		return GetWndRect().width() / m_BoundRect.width();
	}
	const Frect& BoundRect() const
	{
		return m_BoundRect;
	};
	...
	virtual CUIGlobalMapSpot* GlobalMapSpot()
	{
		return NULL;
	}
	...
	bool Locked()
	{
		return !!m_flags.test(eLocked);
	}
	void SetLocked(bool b)
	{
		m_flags.set(eLocked, b);
	}

...
{
	virtual void __stdcall get_bone_transform(LPCSTR name, fmat4x4& transform) = 0;
};
...
struct ISE_Abstract
{
  public:
	...
	IC void set_editor_flag(u32 mask)
	{
  ...
  public:
	...
	virtual fvec3& __stdcall position() = 0;
	virtual fvec3& __stdcall angle() = 0;
	...
	virtual void __stdcall on_render(CDUInterface* du, ISE_AbstractLEOwner* owner, bool bSelected,
									 const fmat4x4& parent, int priority, bool strictB2F) = 0;
};

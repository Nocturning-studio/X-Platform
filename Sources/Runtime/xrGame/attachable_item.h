...
//	bool						m_auto_attach;
  ...
  public:
	...
	static fvec3 get_pos_offset()
	{
		VERIFY(m_dbgItem);
		return m_dbgItem->m_offset.c;
	};
	static void set_angle_offset(fvec3 val)
	{
		fvec3 c = get_pos_offset();

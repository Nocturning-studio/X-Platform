...
void lineClosestApproach(const dVector3 pa, const dVector3 ua, const dVector3 pb, const dVector3 ub, dReal* alpha,
						 dReal* beta)
{
	dVector3 p;
	p[0] = pb[0] - pa[0];
...
extern "C" int dCylBox(const dVector3 p1, const dMatrix3 R1, const dReal radius, const dReal lz, const dVector3 p2,
					   const dMatrix3 R2, const dVector3 side2, dVector3 normal, dReal* depth, int* code, int maxc,
...
extern "C" int dCylCyl(const dVector3 p1, const dMatrix3 R1, const dReal radius1, const dReal lz1, const dVector3 p2,
					   const dMatrix3 R2, const dReal radius2, const dReal lz2, dVector3 normal, dReal* depth,
...
int dCollideCylCyl(dxGeom* o1, dxGeom* o2, int flags, dContactGeom* contact, int skip)
{
	...
	int num =
		dCylCyl(dGeomGetPosition(o1), dGeomGetRotation(o1), cylRadius1, cylLength1, dGeomGetPosition(o2),

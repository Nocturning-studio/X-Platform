...
class CEntityAlive : public CEntity
{
  ...
  public:
	...
	virtual void PHGetLinearVell(fvec3& velocity);
  ...
  protected:
	...
	virtual void BloodyWallmarks(float P, const fvec3& dir, s16 element, const fvec3& position_in_object_space);
  ...
  protected:
	virtual void PlaceBloodWallmark(const fvec3& dir, const fvec3& start_pos, float trace_dist, float wallmark_size,

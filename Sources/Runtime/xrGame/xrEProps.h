...
class XR_EPROPS_API IPropHelper
{
  ...
  public:
	...
	virtual bool __stdcall FvectorRDOnAfterEdit(PropValue* sender, fvec3& edit_val) = 0;
	virtual void __stdcall FvectorRDOnBeforeEdit(PropValue* sender, fvec3& edit_val) = 0;
  ...
  public:
	...
	virtual VectorValue* __stdcall CreateVColor(PropItemVec& items, shared_str key, fvec3* val) = 0;
	...
	virtual CListValue* __stdcall CreateCList(PropItemVec& items, shared_str key, LPSTR val, u32 sz, xr_string* lst,
											  u32 cnt) = 0;
	virtual CTextValue* __stdcall CreateCName(PropItemVec& items, shared_str key, LPSTR val, u32 sz,
											  ListItem* owner) = 0;

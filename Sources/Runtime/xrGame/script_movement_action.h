...
class CScriptMovementAction : public CScriptAbstractAction
{
  ...
  public:
	...
	CScriptMovementAction(MonsterSpace::EBodyState tBodyState, MonsterSpace::EMovementType tMovementType,
						  DetailPathManager::EDetailPathType tPathType, const CPatrolPathParams& tPatrolPathParams,
						  float fSpeed = 0.f);
	IC CScriptMovementAction(MonsterSpace::EBodyState tBodyState, MonsterSpace::EMovementType tMovementType,
							 DetailPathManager::EDetailPathType tPathType, const fvec3& tPosition,
							 float fSpeed = 0.f);
	CScriptMovementAction(const fvec3& tPosition, float fSpeed);
	IC CScriptMovementAction(const EInputKeys tInputKeys, float fSpeed = 0.f);
	// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	// Monsters
	// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	CScriptMovementAction(MonsterSpace::EScriptMonsterMoveAction tAct, fvec3& tPosition, float dist_to_end = -1.f);
	...
	CScriptMovementAction(MonsterSpace::EScriptMonsterMoveAction tAct, CScriptGameObject* tpObjectToGo,
						  float dist_to_end = -1.f);
	CScriptMovementAction(MonsterSpace::EScriptMonsterMoveAction tAct, u32 node_id, fvec3& tPosition,
						  float dist_to_end = -1.f);
	IC CScriptMovementAction(MonsterSpace::EScriptMonsterMoveAction tAct, fvec3& tPosition, float dist_to_end,
	...
	IC void SetPosition(const fvec3& tPosition);

...
class CPHShell : public CPhysicsShell, public CPHObject
{
  ...
  public:
	fmat4x4 m_object_in_root;
	CPHShell();
	virtual ~CPHShell();
	virtual void applyImpulseTrace(const fvec3& pos, const fvec3& dir, float val, const u16 id);
	virtual void applyHit(const fvec3& pos, const fvec3& dir, float val, const u16 id, ALife::EHitType hit_type);

	static void BonesCallback(CBoneInstance* B);
	static void StataticRootBonesCallBack(CBoneInstance* B);
	virtual BoneCallbackFun* GetBonesCallback()
	{
		return BonesCallback;
	}
	...
	virtual void Activate(const fmat4x4& m0, float dt01, const fmat4x4& m2, bool disable = false);
	...
	{
		return m_pPhysicsShellAnimatorC;
	};
#endif
  ...
  public:
	...
	virtual void get_Extensions(const fvec3& axis, float center_prg, float& lo_ext, float& hi_ext);
	virtual void applyForce(const fvec3& dir, float val);
	virtual void applyForce(float x, float y, float z);
	virtual void applyImpulse(const fvec3& dir, float val);
	...
	virtual CPHShellSplitterHolder* SplitterHolder()
	{
	...
	///////	////////////////////////////////////////////////////////////////////////////////////////////
	virtual void get_LinearVel(fvec3& velocity);
	virtual void get_AngularVel(fvec3& velocity);
	virtual void set_LinearVel(const fvec3& velocity);
	virtual void set_AngularVel(const fvec3& velocity);
	virtual void TransformPosition(const fmat4x4& form);
	virtual void SetGlTransformDynamic(const fmat4x4& form);
	...
	virtual CPhysicsElement* NearestToPoint(const fvec3& point);
	...
	virtual void SetRemoveCharacterCollLADisable()
	{
		m_flags.set(flRemoveCharacterCollisionAfterDisable, TRUE);
	}
	virtual bool isEnabled()
	{
		return CPHObject::is_active();
	}
	virtual bool isActive()
	{
		return !!m_flags.test(flActive);
	}
	virtual bool isFullActive()
	{
		return isActive() && !m_flags.test(flActivating);
	}
	void SetNotActivating()
	{
	...
	virtual void NetInterpolationModeON()
	{
		CPHObject::NetInterpolationON();
	}
	virtual void NetInterpolationModeOFF()
	{
	...
	virtual void InterpolateGlobalTransform(fmat4x4* m);
	virtual void InterpolateGlobalPosition(fvec3* v);
	virtual void GetGlobalTransformDynamic(fmat4x4* m);
	virtual void GetGlobalPositionDynamic(fvec3* v);
	virtual fmat4x4& ObjectInRoot()
	{
		return m_object_in_root;
	}
	virtual void ObjectToRootForm(const fmat4x4& form);
  ...
  private:
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void AddElementRecursive(CPhysicsElement* root_e, u16 id, fmat4x4 global_parent, u16 element_number,
							 bool* vis_check);
	void PlaceBindToElFormsRecursive(fmat4x4 parent, u16 id, u16 element, Flags64& mask);
	void BonesBindCalculate(u16 id_from = 0);
	void BonesBindCalculateRecursive(fmat4x4 parent, u16 id);
	...
	void ReanableObject();
	void ExplosionHit(const fvec3& pos, const fvec3& dir, float val, const u16 id);
	void ClearBreakInfo();
};
#endif

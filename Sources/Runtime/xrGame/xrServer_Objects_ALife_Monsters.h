...
#define script_type_list save_type_list(CSE_ALifeCreatureAbstract)
	...
	SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeMonsterAbstract, CSE_ALifeCreatureAbstract,
								 CSE_ALifeSchedulable) GameGraph::_GRAPH_ID m_tNextGraphID;
...
virtual void add_online(const bool& update_registries);
virtual void add_offline(const xr_vector<ALife::_OBJECT_ID>& saved_children, const bool& update_registries);
virtual fvec3 draw_level_position() const;
...
#define script_type_list save_type_list(CSE_ALifeMonsterAbstract)
	...
	SERVER_ENTITY_DECLARE_BEGIN3(CSE_ALifeCreatureActor, CSE_ALifeCreatureAbstract, CSE_ALifeTraderAbstract,
								 CSE_PHSkeleton)
...
#define script_type_list save_type_list(CSE_ALifePsyDogPhantom)
	...
	//-------------------------------
	SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeHumanAbstract, CSE_ALifeTraderAbstract, CSE_ALifeMonsterAbstract) public
...
#define script_type_list save_type_list(CSE_ALifeHumanAbstract)
	...
	SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeHumanStalker, CSE_ALifeHumanAbstract,
								 CSE_PHSkeleton) shared_str m_start_dialog;
...
#define script_type_list save_type_list(CSE_ALifeHumanStalker)
	...
	SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeOnlineOfflineGroup, CSE_ALifeDynamicObject, CSE_ALifeSchedulable) public

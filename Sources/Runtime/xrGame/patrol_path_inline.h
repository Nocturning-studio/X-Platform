...
template <typename T>
IC const CPatrolPath::CVertex* CPatrolPath::point(const fvec3& position, const T& evaluator) const
{
...
IC const CPatrolPath::CVertex* CPatrolPath::point(const fvec3& position) const
{

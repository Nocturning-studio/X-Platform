...
#endif
{
	...
	m_current_center = fvec3().set(flt_max, flt_max, flt_max);
	m_current_radius = fvec3().set(flt_max, flt_max, flt_max);
#endif
#endif
}
...
u32 CLevelGraph::vertex(const fvec3& position) const
{
...
u32 CLevelGraph::vertex_id(const fvec3& position) const
{

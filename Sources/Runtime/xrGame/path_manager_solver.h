...
class CPathManager<CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>, _DataStorage, _Parameters, _dist_type, _index_type,
				   _iteration_type>
	: public CPathManagerGeneric<CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>, _DataStorage, _Parameters, _dist_type,
								 _index_type, _iteration_type>
{
  ...
  protected:
	...
	typename inherited::const_iterator m_iterator;
  ...
  public:
	...
	IC const _index_type& get_value(typename inherited::const_iterator& i, bool reverse_search = typename _Graph::reverse_search) const;
	IC const _edge_type& edge(typename inherited::const_iterator& i) const;

...
#define script_type_list save_type_list(CSE_ALifePHSkeletonObject)
	...
	SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeSpaceRestrictor, CSE_ALifeDynamicObject,
								 CSE_Shape) u8 m_space_restrictor_type;
...
virtual void __stdcall on_render(CDUInterface* du, ISE_AbstractLEOwner* owner, bool bSelected, const fmat4x4& parent,
...
#define script_type_list save_type_list(CSE_ALifeObjectProjector)
	...
	SERVER_ENTITY_DECLARE_BEGIN3(CSE_ALifeHelicopter, CSE_ALifeDynamicObjectVisual, CSE_Motion,
								 CSE_PHSkeleton) shared_str engine_sound;

...
void CScriptSoundAction::script_register(lua_State* L)
{
	module(L)[class_<CScriptSoundAction>("sound")
				  ...
				  .def(constructor<LPCSTR, LPCSTR, const fvec3&>())
				  .def(constructor<LPCSTR, LPCSTR, const fvec3&, const fvec3&>())
				  .def(constructor<LPCSTR, LPCSTR, const fvec3&, const fvec3&, bool>())
				  .def(constructor<LPCSTR, const fvec3&>())
				  .def(constructor<LPCSTR, const fvec3&, const fvec3&>())
				  .def(constructor<LPCSTR, const fvec3&, const fvec3&, bool>())
				  .def(constructor<CScriptSound&, LPCSTR, const fvec3&>())
				  .def(constructor<CScriptSound&, LPCSTR, const fvec3&, const fvec3&>())
				  .def(constructor<CScriptSound&, LPCSTR, const fvec3&, const fvec3&, bool>())
				  .def(constructor<CScriptSound&, const fvec3&>())
				  .def(constructor<CScriptSound&, const fvec3&, const fvec3&>())
				  .def(constructor<CScriptSound&, const fvec3&, const fvec3&, bool>())
				  // monster specific

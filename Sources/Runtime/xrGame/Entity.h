...
class CEntity : public CPhysicsShellHolder, public CDamageManager
{
  ...
  public:
	/*virtual*/ IC float GetfHealth() const
	{
  ...
  public:
	...
	/*	virtual*/ IC void SetMaxHealth(float v)
	{
		m_entity_condition->max_health() = v;
	}

	/*virtual*/ IC BOOL g_Alive() const
	{
		return GetfHealth() > 0;
	}
	...
	virtual void HitSignal(float P, fvec3& local_dir, CObject* who, s16 element) = 0;
	virtual void HitImpulse(float P, fvec3& vWorldDir, fvec3& vLocalDir) = 0;

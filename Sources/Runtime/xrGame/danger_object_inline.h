...
IC CDangerObject::CDangerObject(const CEntityAlive* object, const fvec3& position, u32 time, const EDangerType& type,
...
IC const fvec3& CDangerObject::position() const
{
	return (m_position);
}

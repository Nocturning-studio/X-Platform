...
void CWeaponStatMgun::UpdateBarrelDir()
{
	...
	m_cur_x_rot = angle_inertion_var(m_cur_x_rot, m_tgt_x_rot, 0.5f, 3.5f, PI_DIV_6, Engine.TimeManager.GetDeltaTime());
	m_cur_y_rot = angle_inertion_var(m_cur_y_rot, m_tgt_y_rot, 0.5f, 3.5f, PI_DIV_6, Engine.TimeManager.GetDeltaTime());
}

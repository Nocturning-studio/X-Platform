...
void CObjectScript::script_register(lua_State* L)
{
	module(L)[
		...
		/*
					...
					.def("spatial_unregister",	&CObject::spatial_unregister,
		   &CObjectWrapper::spatial_unregister_static) .def("spatial_move",		&CObject::spatial_move,
		   &CObjectWrapper::spatial_move_static)
		...
		*/
		...
		//,&CObject::renderable_Render,&CObjectWrapper::renderable_Render_static)
		...
		class_<CGameObject, bases<DLL_Pure, ISheduled, ICollidable, IRenderable>, CGameObjectWrapper>("CGameObject")
			...
			/*
			   ...
			   &CGameObjectWrapper::spatial_register_static) .def("spatial_unregister",
			   &CGameObject::spatial_unregister,	&CGameObjectWrapper::spatial_unregister_static) .def("spatial_move",
			   &CGameObject::spatial_move,		&CGameObjectWrapper::spatial_move_static)
			   ...
			   &CGameObjectWrapper::dcast_FeelSound_static) .def("dcast_Light",			&CGameObject::dcast_Light,
			   &CGameObjectWrapper::dcast_Light_static)
			*/
			//			.def("shedule_Scale",		&CGameObject::shedule_Scale,
			//&CGameObjectWrapper::shedule_Scale_static) 			.def("shedule_Update",		&CGameObject::shedule_Update,
...
{
	module(L)[class_<IRender_Visual>("IRender_Visual")
				  .def(constructor<>())
...
{
	module(L)[class_<CKinematicsAnimated>("CKinematicsAnimated").def("PlayCycle", &CKinematicsAnimated_PlayCycle)];
}

...
struct CDataStorageConstructor
	: public _algorithm::template CDataStorage<
		  _manager_builder_allocator_constructor<_manager, _builder, _allocator, _builder_allocator_constructor>,
		  _vertex>
{
	...
	IC CDataStorageConstructor(const u32 vertex_count) : inherited(vertex_count)
	{
	}
};

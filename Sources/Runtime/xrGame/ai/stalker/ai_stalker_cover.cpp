...
const CCoverPoint* CAI_Stalker::find_best_cover(const fvec3& position_to_cover_from)
{
#ifdef _DEBUG
...
float CAI_Stalker::best_cover_value(const fvec3& position_to_cover_from)
{
	m_ce_best->setup(position_to_cover_from, MIN_SUITABLE_ENEMY_DISTANCE, 170.f, MIN_SUITABLE_ENEMY_DISTANCE);
...
const CCoverPoint* CAI_Stalker::best_cover(const fvec3& position_to_cover_from)
{

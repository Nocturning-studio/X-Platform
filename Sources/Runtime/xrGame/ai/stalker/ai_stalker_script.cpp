		...
		[class_<CStalkerPlanner>("stalker_ids")
			 .enum_("properties")
				 [luabind::value("property_alive", StalkerDecisionSpace::eWorldPropertyAlive),
				  ...
				  luabind::value("property_use_crouch_to_look_out",
								 StalkerDecisionSpace::eWorldPropertyUseCrouchToLookOut),
			 ...
			 .enum_("action")
				 [luabind::value("action_dead", StalkerDecisionSpace::eWorldOperatorDead),
				  ...
				  luabind::value("action_reach_customer_location",
								 StalkerDecisionSpace::eWorldOperatorReachCustomerLocation),
				  ...
				  luabind::value("action_prepare_wounded_enemy",
								 StalkerDecisionSpace::eWorldOperatorPrepareWoundedEnemy),
				  ...
				  luabind::value("action_danger_unknown_planner",
								 StalkerDecisionSpace::eWorldOperatorDangerUnknownPlanner),
				  luabind::value("action_danger_in_direction_planner",
								 StalkerDecisionSpace::eWorldOperatorDangerInDirectionPlanner),
				  luabind::value("action_danger_grenade_planner",
								 StalkerDecisionSpace::eWorldOperatorDangerGrenadePlanner),
				  luabind::value("action_danger_by_sound_planner",
								 StalkerDecisionSpace::eWorldOperatorDangerBySoundPlanner),
				  ...
				  luabind::value("action_danger_grenade_search",
								 StalkerDecisionSpace::eWorldOperatorDangerGrenadeSearch),

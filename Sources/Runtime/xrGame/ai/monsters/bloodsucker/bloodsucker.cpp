...
void CAI_Bloodsucker::LookDirection(fvec3 to_dir, float bone_turn_speed)
{
...
void CAI_Bloodsucker::predator_start()
{
	...
	CParticlesPlayer::StartParticles(invisible_particle_name, fvec3().set(0.0f, 0.1f, 0.0f), ID());
...
void CAI_Bloodsucker::HitEntity(const CEntity* pEntity, float fDamage, float impulse, fvec3& dir)
{

...
#include "xrGame/monster_community.h"
...
void CController::control_hit()
{
	...
	Actor()->Cameras().AddCamEffector(
		xr_new<CMonsterEffectorHit>(m_control_effector.ce_time, m_control_effector.ce_amplitude,
	...
	/*
		...
		time_control_hit_started	= Engine.TimeManager.GetGlobalTimeMs();
	*/
}

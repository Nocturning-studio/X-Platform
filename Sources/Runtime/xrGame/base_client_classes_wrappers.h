...
public:
	...
	{
		return	(call_member<fvec3>(this,"spatial_sector_point"));
	}

	static	fvec3			spatial_sector_point_static	(base *self)
	{
...
class ISheduledWrapper : public heritage<base, luabind_base>::result
{
  public:
	...
	/*	static float			shedule_Scale_static	(base *self)
		{
			ai().script_engine().script_log(eLuaMessageTypeError,"You are trying to call a pure virtual function
	   ISheduled::shedule_Scale!\nReturning default value 1000.0"); return	(1000.f);
		}
	*/
...
class CEntityWrapper : public CEntity, public luabind::wrap_base
{
  public:
	...
	static void HitSignal_static(CEntity* self, float P, fvec3& local_dir, CObject* who, s16 element)
	{
	...
	static void HitImpulse_static(float P, fvec3& vWorldDir, fvec3& vLocalDir)
	{
		ai().script_engine().script_log(eLuaMessageTypeError,

...
TEMPLATE_SPECIALIZATION
template <typename T>
IC const typename CAbstractOperator::CSConditionState& CAbstractOperator::apply(const CSConditionState& current,
...
TEMPLATE_SPECIALIZATION
IC const typename CAbstractOperator::CSConditionState& CAbstractOperator::apply(const CSConditionState& condition,
...
TEMPLATE_SPECIALIZATION
IC typename CAbstractOperator::_edge_value_type CAbstractOperator::weight(const CSConditionState& condition0,

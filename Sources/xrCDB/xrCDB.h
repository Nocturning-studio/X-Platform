...
class XRCDB_API MODEL
{
  ...
  public:
	...
	IC Fvector* get_verts()
	{
		return verts;
	}
	IC int get_verts_count() const
	{
		return verts_count;
	}
	IC TRI* get_tris()

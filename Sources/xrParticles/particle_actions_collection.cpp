...
void PAPI::PAAvoid::Transform(const fmat4x4& m)
{
...
void PABounce::Transform(const fmat4x4& m)
{
	position.transform(positionL, m);
}
//-------------------------------------------------------------------------------------------------
...
void PACopyVertexB::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PADamping::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PAExplosion::Transform(const fmat4x4& m)
{
...
void PAFollow::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PAGravitate::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PAGravity::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PAJet::Transform(const fmat4x4& m)
{
	m.transform_tiny(center, centerL);
...
void PAScatter::Transform(const fmat4x4& m)
{
	m.transform_tiny(center, centerL);
}
//-------------------------------------------------------------------------------------------------
...
void PAKillOld::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PAMatchVelocity::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PAMove::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PAOrbitLine::Transform(const fmat4x4& m)
{
...
void PAOrbitPoint::Transform(const fmat4x4& m)
{
	m.transform_tiny(center, centerL);
}
//-------------------------------------------------------------------------------------------------
...
void PARandomAccel::Transform(const fmat4x4& m)
{
...
void PARandomDisplace::Transform(const fmat4x4& m)
{
...
void PARandomVelocity::Transform(const fmat4x4& m)
{
...
void PARestore::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PASink::Transform(const fmat4x4& m)
{
	position.transform(positionL, m);
}
//-------------------------------------------------------------------------------------------------
...
void PASinkVelocity::Transform(const fmat4x4& m)
{
...
void PASource::Transform(const fmat4x4& m)
{
	position.transform(positionL, m);
	velocity.transform_dir(velocityL, m);
}
...
void PASpeedLimit::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PATargetColor::Transform(const fmat4x4&)
{
}
//-------------------------------------------------------------------------------------------------
...
void PATargetSize::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PATargetRotate::Transform(const fmat4x4&)
{
	;
}
//-------------------------------------------------------------------------------------------------
...
void PATargetVelocity::Transform(const fmat4x4& m)
{
...
void PAVortex::Transform(const fmat4x4& m)
{
	m.transform_tiny(center, centerL);
	m.transform_dir(axis, axisL);
}
...
void PATurbulence::Transform(const fmat4x4& m)
{
}
//-------------------------------------------------------------------------------------------------

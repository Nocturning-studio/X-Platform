  ...
  public:
	...
	void CBlender_Screen_SET::Compile(CBlender_Compile& C)
	{
		...
		case 0: // SET
			...
			break;
		case 1: // BLEND
			C.PassSET_Blend(TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
			break;
		case 2: // ADD
			C.PassSET_Blend(TRUE, D3DBLEND_ONE, D3DBLEND_ONE);
			break;
		case 3: // MUL
			C.PassSET_Blend(TRUE, D3DBLEND_DESTCOLOR, D3DBLEND_ZERO);
			break;
		case 4: // MUL_2X
			C.PassSET_Blend(TRUE, D3DBLEND_DESTCOLOR, D3DBLEND_SRCCOLOR);
			break;
		case 5: // ALPHA-ADD
			C.PassSET_Blend(TRUE, D3DBLEND_SRCALPHA, D3DBLEND_ONE);
			break;
		case 6: // MUL_2X + A-test
			C.PassSET_Blend(TRUE, D3DBLEND_DESTCOLOR, D3DBLEND_SRCCOLOR);
			break;
		case 7: // SET (2r)
			C.PassSET_Blend(TRUE, D3DBLEND_ONE, D3DBLEND_ZERO);
			break;
		case 8: // BLEND (2r)
			C.PassSET_Blend(TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
			break;

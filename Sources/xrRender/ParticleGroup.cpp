...
void CParticleGroup::SItem::UpdateParent(const fmat4x4& m, const fvec3& velocity, BOOL bTransform)
{
	CParticleEffect* PE = static_cast<CParticleEffect*>(_effect);
	if (PE)
...
void CParticleGroup::UpdateParent(const fmat4x4& m, const fvec3& velocity, BOOL bTransform)
{
